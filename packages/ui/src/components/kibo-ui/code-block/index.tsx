// changed bg-secondary to bg-muted
'use client';
...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      'flex flex-row items-center border-b bg-muted p-1',
      className
    )}
    {...props}
  />
...
export const CodeBlockFilename = ({
  ...
  return (
    <div
      className="flex items-center gap-2 bg-muted px-4 py-1.5 text-muted-foreground text-xs"
      {...props}
    >
