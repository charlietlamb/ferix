...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@ferix/ui/components/shadcn/sheet';
import { Skeleton } from '@ferix/ui/components/shadcn/skeleton';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      className={cn(
        'relative flex w-full flex-1 flex-col bg-background flex-grow',
